        ...
        options: {
          users: {
            ...
            2: {
              ...
              name: 'AnonPanda',
              avatarUrl:
                'https://img.freepik.com/free-vector/cute-panda-gaming-cartoon-icon-illustration-animal-technology-icon-concept-premium-flat-cartoon-style_138676-2685.jpg',
            },
          },
          myUserId: '2',
        },
