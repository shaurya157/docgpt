...
export const editDocumentPrompt = (state: TAgentState) => {
    ...
    console.log("Active Document:", JSON.stringify(state.activeDocument));
    return `
        ...
        ${rules([
            ...
            `Respond back in the following XML format for each edit you make:
                <Edit><Original>This is a sample original text which the user wants to change</Original><New>This is a sample new text generated by you</New></Edit>
                <Edit><Original>This is a second sample of original text</Original><New>This is a second sample of new text</New></Edit>
                ...
            `,
        ...
        ${formattingInstructions([
            ...
            `NEVER add any extra whitespace in the <New> text. Keep the generated text as clean as possible.`,
            `When writing the <Original> text, make sure to keep ALL content from the original text. Do not remove any content, do not add any new lines or extra whitespace. DO NOT make any modifications to the original text.`,
        ])}
    `;
}
