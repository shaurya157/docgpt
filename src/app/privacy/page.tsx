      ...
      <main className="flex-grow container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="max-w-4xl mx-auto">
          ...
          <ul className="list-disc pl-6 mb-8 space-y-2 text-gray-700">
            <li><strong className="font-semibold text-gray-800">What personal information do we process?</strong> When you visit, use, or navigate our Services, we may process personal information depending on how you interact with us and the Services, the choices you make, and the products and features you use. Learn more about <a href="#section-1" className="text-blue-600 hover:text-blue-800 hover:underline">personal information you disclose to us</a>.</li>
            ...
            <li><strong className="font-semibold text-gray-800">How do we process your information?</strong> We process your information to provide, improve, and administer our Services, communicate with you, for security and fraud prevention, and to comply with law. We may also process your information for other purposes with your consent. Learn more about <a href="#section-2" className="text-blue-600 hover:text-blue-800 hover:underline">how we process your information</a>.</li>
            <li><strong className="font-semibold text-gray-800">In what situations and with which parties do we share personal information?</strong> We may share information in specific situations and with specific third parties. Learn more about <a href="#section-4" className="text-blue-600 hover:text-blue-800 hover:underline">when and with whom we share your personal information</a>.</li>
            <li><strong className="font-semibold text-gray-800">How do we keep your information safe?</strong> We have adequate organizational and technical processes and procedures in place to protect your personal information. However, no electronic transmission over the internet or information storage technology can be guaranteed to be 100% secure, so we cannot promise or guarantee that hackers, cybercriminals, or other unauthorized third parties will not be able to defeat our security and improperly collect, access, steal, or modify your information. Learn more about <a href="#section-9" className="text-blue-600 hover:text-blue-800 hover:underline">how we keep your information safe</a>.</li>
            <li><strong className="font-semibold text-gray-800">What are your rights?</strong> Depending on where you are located geographically, the applicable privacy law may mean you have certain rights regarding your personal information. Learn more about <a href="#section-11" className="text-blue-600 hover:text-blue-800 hover:underline">your privacy rights</a>.</li>
          ...
          <ol className="list-decimal pl-6 mb-8 space-y-2 text-gray-700">
            <li><a href="#section-1" className="text-blue-600 hover:text-blue-800 hover:underline">WHAT INFORMATION DO WE COLLECT?</a></li>
            <li><a href="#section-2" className="text-blue-600 hover:text-blue-800 hover:underline">HOW DO WE PROCESS YOUR INFORMATION?</a></li>
            <li><a href="#section-3" className="text-blue-600 hover:text-blue-800 hover:underline">WHAT LEGAL BASES DO WE RELY ON TO PROCESS YOUR PERSONAL INFORMATION?</a></li>
            <li><a href="#section-4" className="text-blue-600 hover:text-blue-800 hover:underline">WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?</a></li>
            <li><a href="#section-5" className="text-blue-600 hover:text-blue-800 hover:underline">DO WE USE COOKIES AND OTHER TRACKING TECHNOLOGIES?</a></li>
            <li><a href="#section-6" className="text-blue-600 hover:text-blue-800 hover:underline">DO WE OFFER ARTIFICIAL INTELLIGENCE-BASED PRODUCTS?</a></li>
            <li><a href="#section-7" className="text-blue-600 hover:text-blue-800 hover:underline">HOW DO WE HANDLE YOUR SOCIAL LOGINS?</a></li>
            <li><a href="#section-8" className="text-blue-600 hover:text-blue-800 hover:underline">HOW LONG DO WE KEEP YOUR INFORMATION?</a></li>
            <li><a href="#section-9" className="text-blue-600 hover:text-blue-800 hover:underline">HOW DO WE KEEP YOUR INFORMATION SAFE?</a></li>
            <li><a href="#section-10" className="text-blue-600 hover:text-blue-800 hover:underline">DO WE COLLECT INFORMATION FROM MINORS?</a></li>
            <li><a href="#section-11" className="text-blue-600 hover:text-blue-800 hover:underline">WHAT ARE YOUR PRIVACY RIGHTS?</a></li>
            <li><a href="#section-12" className="text-blue-600 hover:text-blue-800 hover:underline">CONTROLS FOR DO-NOT-TRACK FEATURES</a></li>
            <li><a href="#section-13" className="text-blue-600 hover:text-blue-800 hover:underline">DO UNITED STATES RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</a></li>
            <li><a href="#section-14" className="text-blue-600 hover:text-blue-800 hover:underline">DO OTHER REGIONS HAVE SPECIFIC PRIVACY RIGHTS?</a></li>
            <li><a href="#section-15" className="text-blue-600 hover:text-blue-800 hover:underline">DO WE MAKE UPDATES TO THIS NOTICE?</a></li>
            <li><a href="#section-16" className="text-blue-600 hover:text-blue-800 hover:underline">HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</a></li>
            <li><a href="#section-17" className="text-blue-600 hover:text-blue-800 hover:underline">HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?</a></li>
          </ol>
          ...
          <p className="mb-4 text-gray-700 leading-relaxed"><strong className="font-semibold text-gray-800">Social Media Login Data.</strong> If you register via social media (e.g., Facebook, X), we collect certain profile information as described under <a href="#section-7" className="text-blue-600 hover:text-blue-800 hover:underline">“HOW DO WE HANDLE YOUR SOCIAL LOGINS?”</a></p>
